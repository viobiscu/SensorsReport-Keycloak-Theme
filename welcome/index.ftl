...
<html lang="en">
  ...
  <body data-page-id="welcome">
    <div class="pf-v5-c-background-image" style="--pf-v5-c-background-image--BackgroundImage: url(${resourcesPath}/img/${properties.backgroundImage})"></div>
    <div class="pf-v5-c-login">
      <div class="pf-v5-c-login__container">
        <header class="pf-v5-c-login__header">
          <div class="pf-v5-c-brand">
            <img src="${resourcesPath}/img/${properties.logo}" alt="${productName} Logo" class="kc-brand">
          </div>
        </header>
